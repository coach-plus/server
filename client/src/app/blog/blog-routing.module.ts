    ...
    children: [
      {
        ...
        data: {
          title: "Blog List | Chatloop Landing Page"
        }
      },
      {
        path: 'details',
        ...
        data: {
          title: "Blog Detail | Chatloop Landing Page"
        }
      }, 
      {
        path: 'left-sidebar',
        ...
        data: {
          title: "Left Sidebar Blog| Chatloop Landing Page"
        }
      }, 
      {
        path: 'right-sidebar',
        ...
        data: {
          title: "Right Sidebar Blog | Chatloop Landing Page"
        }
      }, 
      {
        ...
        data: {
          title: "Detail Left Sidebar Blog | Chatloop Landing Page"
        }
      },
      {
        ...
        data: {
          title: "Detail Right Sidebar Blog | Chatloop Landing Page"
        }
      }         
    ]
  }
